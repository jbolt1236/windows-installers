...
namespace Elastic.Installer.Msi.Elasticsearch.CustomActions.Install
{
	public class ElasticsearchBootstrapPasswordAction : CustomAction<Elasticsearch>
	{
		...
		public override Condition Condition => new Condition("(NOT Installed) AND XPACKSECURITYENABLED~=\"true\"");
		public override Return Return => Return.check;
		public override Sequence Sequence => Sequence.InstallExecuteSequence;
		public override When When => When.After;
		public override Step Step => new Step(nameof(ElasticsearchCertsAction));
